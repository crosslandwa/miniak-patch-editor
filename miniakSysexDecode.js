...
/**
 * REALTIIME CONTROLLERS
 */ 
['controller::X', 411, 0, 219, 792, 'convertController'],
['controller::Y', 156, 0, 219, 800, 'convertController'],
['controller::Z', 413, 0, 219, 808, 'convertController'],
];
...
function convertController (rawValue, index, decoder)
{
    if (rawValue >= 180) {
        rawValue -= 18;
    }
