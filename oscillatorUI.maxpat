	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 270.5, 381.5, 32.5, 18.0 ],
					"outlettype" : [ "int" ],
					"id" : "obj-42",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 1,
					"presentation_rect" : [ 528.0, 0.0, 38.0, 18.0 ],
					"numoutlets" : 0,
					"patching_rect" : [ 322.5, 305.5, 39.5, 18.0 ],
					"presentation" : 1,
					"id" : "obj-36",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "number",
					"hint" : "Balance of oscillator output sent to Filter 1",
					"hbgcolor" : [ 0.0, 0.0, 0.0, 0.501961 ],
					"htextcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"fontsize" : 10.0,
					"numinlets" : 1,
					"presentation_rect" : [ 496.0, 0.0, 32.0, 18.0 ],
					"numoutlets" : 2,
					"minimum" : 0,
					"patching_rect" : [ 271.0, 307.0, 50.0, 18.0 ],
					"outlettype" : [ "int", "bang" ],
					"presentation" : 1,
					"maximum" : 100,
					"id" : "obj-37",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 2,
					"patching_rect" : [ 270.5, 353.5, 49.0, 18.0 ],
					"outlettype" : [ "", "" ],
					"id" : "obj-38",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 270.5, 330.5, 52.0, 18.0 ],
					"outlettype" : [ "" ],
					"id" : "obj-39",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 270.5, 282.5, 63.0, 18.0 ],
					"outlettype" : [ "" ],
					"id" : "obj-40",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 270.5, 258.5, 32.5, 18.0 ],
					"outlettype" : [ "int" ],
					"id" : "obj-41",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 1,
					"presentation_rect" : [ 600.0, 0.0, 38.0, 18.0 ],
					"numoutlets" : 0,
					"patching_rect" : [ 418.5, 306.5, 39.5, 18.0 ],
					"presentation" : 1,
					"id" : "obj-20",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "number",
					"hint" : "Balance of oscillator output sent to Filter 2",
					"hbgcolor" : [ 0.0, 0.0, 0.0, 0.501961 ],
					"htextcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"fontsize" : 10.0,
					"numinlets" : 1,
					"presentation_rect" : [ 568.0, 0.0, 32.0, 18.0 ],
					"numoutlets" : 2,
					"minimum" : 0,
					"patching_rect" : [ 367.0, 308.0, 50.0, 18.0 ],
					"outlettype" : [ "int", "bang" ],
					"presentation" : 1,
					"maximum" : 100,
					"id" : "obj-27",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 2,
					"patching_rect" : [ 366.5, 354.5, 49.0, 18.0 ],
					"outlettype" : [ "", "" ],
					"id" : "obj-28",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 366.5, 331.5, 52.0, 18.0 ],
					"outlettype" : [ "" ],
					"id" : "obj-29",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 366.5, 378.5, 32.5, 18.0 ],
					"outlettype" : [ "int" ],
					"id" : "obj-30",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 366.5, 283.5, 63.0, 18.0 ],
					"outlettype" : [ "" ],
					"id" : "obj-31",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 366.5, 259.5, 32.5, 18.0 ],
					"outlettype" : [ "int" ],
					"id" : "obj-32",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 330.0, 231.0, 74.0, 18.0 ],
					"id" : "obj-33",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"minimum" : -50,
					"patching_rect" : [ 271.0, 231.0, 50.0, 18.0 ],
					"outlettype" : [ "int", "bang" ],
					"maximum" : 50,
					"id" : "obj-35",
					"fontname" : "Arial"
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 1,
					"presentation_rect" : [ 472.0, 0.0, 17.0, 18.0 ],
					"numoutlets" : 0,
					"patching_rect" : [ 127.0, 338.0, 19.0, 18.0 ],
					"presentation" : 1,
					"id" : "obj-3",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "number",
					"hint" : "Volume of the oscillator signal sent to the filters",
					"varname" : "Level",
					"hbgcolor" : [ 0.0, 0.0, 0.0, 0.501961 ],
					"htextcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"fontsize" : 10.0,
					"numinlets" : 1,
					"presentation_rect" : [ 440.0, 0.0, 48.0, 18.0 ],
					"numoutlets" : 2,
					"minimum" : 0,
					"patching_rect" : [ 71.0, 336.0, 50.0, 18.0 ],
					"outlettype" : [ "int", "bang" ],
					"presentation" : 1,
					"maximum" : 100,
					"id" : "obj-5",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 7.0, 336.0, 61.0, 18.0 ],
					"id" : "obj-14",
					"fontname" : "Arial"
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 280.0, 406.0, 257.0, 406.0, 257.0, 225.0, 280.5, 225.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-35", 0 ],
					"hidden" : 0,
					"midpoints" : [ 376.0, 414.0, 253.0, 414.0, 253.0, 218.0, 280.5, 218.0 ]
				}
